...
var wasmImports = {
  ...
  /** @export */ K: ___call_sighandler,
  /** @export */ F: ___syscall__newselect,
  /** @export */ s: ___syscall_chdir,
  /** @export */ r: ___syscall_chmod,
  /** @export */ p: ___syscall_dup3,
  /** @export */ t: ___syscall_faccessat,
  /** @export */ N: ___syscall_fadvise64,
  /** @export */ ba: ___syscall_fchdir,
  /** @export */ aa: ___syscall_fchmod,
  /** @export */ n: ___syscall_fchmodat2,
  /** @export */ _: ___syscall_fchown32,
  /** @export */ q: ___syscall_fchownat,
  /** @export */ c: ___syscall_fcntl64,
  /** @export */ Z: ___syscall_fdatasync,
  /** @export */ Y: ___syscall_fstat64,
  /** @export */ T: ___syscall_ftruncate64,
  /** @export */ J: ___syscall_getdents64,
  /** @export */ h: ___syscall_ioctl,
  /** @export */ V: ___syscall_lstat64,
  /** @export */ l: ___syscall_mkdirat,
  /** @export */ k: ___syscall_mknodat,
  /** @export */ W: ___syscall_newfstatat,
  /** @export */ e: ___syscall_openat,
  /** @export */ O: ___syscall_pipe,
  /** @export */ j: ___syscall_readlinkat,
  /** @export */ H: ___syscall_renameat,
  /** @export */ G: ___syscall_rmdir,
  /** @export */ X: ___syscall_stat64,
  /** @export */ E: ___syscall_statfs64,
  /** @export */ D: ___syscall_symlinkat,
  /** @export */ i: ___syscall_unlinkat,
  /** @export */ B: ___syscall_utimensat,
  /** @export */ ea: __abort_js,
  /** @export */ o: __emscripten_get_now_is_monotonic,
  /** @export */ M: __emscripten_get_progname,
  /** @export */ L: __emscripten_runtime_keepalive_clear,
  /** @export */ y: __emscripten_throw_longjmp,
  /** @export */ P: __gmtime_js,
  /** @export */ Q: __localtime_js,
  /** @export */ ga: __tzset_js,
  /** @export */ f: _emscripten_date_now,
  /** @export */ C: _emscripten_get_heap_max,
  /** @export */ ca: _emscripten_get_now,
  /** @export */ A: _emscripten_resize_heap,
  /** @export */ v: _environ_get,
  /** @export */ w: _environ_sizes_get,
  /** @export */ a: _exit,
  /** @export */ d: _fd_close,
  ...
  /** @export */ U: _fd_sync,
  /** @export */ g: _fd_write,
  /** @export */ x: _getaddrinfo,
  /** @export */ R: invoke_ii,
  /** @export */ $: invoke_iii,
  /** @export */ da: invoke_vi,
  /** @export */ z: invoke_viii,
...
var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["ja"])(a0, a1);

var _fflush = a0 => (_fflush = wasmExports["la"])(a0);

var _malloc = a0 => (_malloc = wasmExports["ma"])(a0);

var ___funcs_on_exit = () => (___funcs_on_exit = wasmExports["na"])();
