...
var Module = (() => {
    ...
    return (function (moduleArg = {}) {
        ...
        function createWasm() { var info = { "a": wasmImports }; function receiveInstance(instance, module) { var exports = instance.exports; wasmExports = exports; wasmMemory = wasmExports["p"]; updateMemoryViews(); wasmTable = wasmExports["t"]; addOnInit(wasmExports["q"]); removeRunDependency("wasm-instantiate"); return exports; } addRunDependency("wasm-instantiate"); function receiveInstantiationResult(result) { receiveInstance(result["instance"]); } if (Module["instantiateWasm"]) {
            try {
        ...
        var wasmImports = { n: ___syscall_dup3, a: ___syscall_fcntl64, f: ___syscall_ioctl, g: ___syscall_openat, k: __emscripten_throw_longjmp, o: _abort, h: _emscripten_date_now, i: _emscripten_memcpy_big, l: _emscripten_resize_heap, b: _exit, d: _fd_close, e: _fd_read, m: _fd_seek, c: _fd_write, j: invoke_vii };
        var wasmExports = createWasm();
        var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["q"])();
        var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["r"])(a0, a1);
        var ___errno_location = () => (___errno_location = wasmExports["s"])();
        var _malloc = a0 => (_malloc = wasmExports["malloc"])(a0);
        var _free = a0 => (_free = wasmExports["free"])(a0);
        var _setThrew = (a0, a1) => (_setThrew = wasmExports["u"])(a0, a1);
