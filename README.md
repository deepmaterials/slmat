...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Python basics for beginners](https://github.com/deepmaterials/slmat/blob/develop/content/python_novice_notebook.ipynb)                                                       | [![Open in SLMat]](https://raw.githubusercontent.com/deepmaterials/slmat/refs/heads/develop/content/python_novice_notebook.ipynb)                                 | Python for beginners discussing variable types, arrays, plotting data etc.                                                                                                                                                                                                                                                                       |
...
| [Silicon atomic structure analysis](https://github.com/deepmaterials/slmat/blob/develop/content/Silicon_atomic_structure_and_analysis_example.ipynb)                                                       | [![Open in SLMat]](https://deepmaterials.github.io/slmat/lab?fromURL=https://raw.githubusercontent.com/deepmaterials/slmat/main/content/Silicon_atomic_structure_and_analysis_example.ipynb)                                 | Examples on how to create an atomic structure such as for silicon, creating defects, X-ray diffraction analysis and more.                                                                                                                                                                                                                                                                       |
